      ...
      <header className="bg-red-400 p-4 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <nav className="space-x-4">
            ...
            <a href="#contacts" className="text-gray-200 hover:underline">
              Contacts
            </a>
            <a href="#courses" className="text-gray-200 hover:underline">
              Courses
            </a>
          </nav>
        </div>
        <button className="border border-white text-white py-1 px-3 rounded">
          Login
        </button>
      </header>
